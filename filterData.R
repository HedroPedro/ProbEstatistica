...
primer <- "Top4Amunorpi_Curitiba_IBGE_OK.csv"
velocidad <- "Velocidade_Contratada_SCM.csv"

filter_csv_Velocidade(primer, velocidad, "Top4Amunorpi_Curitiba_velocidade.csv")
